...
export class Log {
    ...
    static detail(s) {
        if (app.ui.settings.getSettingValue("Pepe Image Filter.Z.Detailed Logging")) Log.log(s)
    }
    static message_in(message, extra) {
        if (!app.ui.settings.getSettingValue("Pepe Image Filter.Z.Detailed Logging")) return
